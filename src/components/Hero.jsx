...
import halalBadge from "../assets/halal-img.png";
        ...
        >
          ...
          <div className="relative w-72 h-72 sm:w-[420px] sm:h-[420px] animate-float">
            ...
            <img
              src={halalBadge}
              alt="100% Halal"
              className="absolute top-2 right-2 sm:top-4 sm:right-4 rounded-full w-16 h-16 sm:w-20 sm:h-20 z-30 drop-shadow-xl"
            />
            <img
